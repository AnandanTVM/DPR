<%@ Page Title="" Language="C#" MasterPageFile="~/Financagencie.master" AutoEventWireup="true" CodeFile="financialrec.aspx.cs" Inherits="financialrec" %>
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
    ...
    <Columns>
        ...
        <asp:HyperLinkField DataNavigateUrlFields="cid" 
            DataNavigateUrlFormatString="financialrec1.aspx?{0}" DataTextField="title" 
            HeaderText="SUBJECT" />
    </Columns>
