<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="Adminrec.aspx.cs" Inherits="Adminrec" %>
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
    ...
    onselectedindexchanged="GridView1_SelectedIndexChanged" Width="589px">
    ...
    <Columns>
        ...
        <asp:HyperLinkField DataNavigateUrlFields="cid" 
            DataNavigateUrlFormatString="Adminrec1.aspx?{0}" DataTextField="title" 
            HeaderText="SUBJECT" />
    </Columns>
