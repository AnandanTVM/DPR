...
public partial class citizendoubtsexprt : System.Web.UI.Page
{
    SqlConnection con;
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand("insert into expdoubts values('" + uname + "','" + d1 + "','" + TextBox1.Text + "','" + TextBox2.Text + "',null,null,0)", con);
        cmd.ExecuteNonQuery();
