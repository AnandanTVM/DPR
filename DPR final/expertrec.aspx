<%@ Page Title="" Language="C#" MasterPageFile="~/Experts.master" AutoEventWireup="true" CodeFile="expertrec.aspx.cs" Inherits="expertrec" %>
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
    ...
    <Columns>
        ...
        <asp:HyperLinkField DataNavigateUrlFields="cid" 
            DataNavigateUrlFormatString="expertrec1.aspx?{0}" DataTextField="title" 
            HeaderText="SUBJECT" />
    </Columns>
