...
public partial class expertdoubtsrespons1 : System.Web.UI.Page
{
    SqlConnection con;
    SqlCommand comm;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            comm = new SqlCommand("select * from expdoubts where did=" + id + "", con);
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        con.Open();
        comm = new SqlCommand("update expdoubts set status=1,replay='" + TextBox1.Text + "',replaydate='" + d1 + "'  where did=" + id + "", con);
        comm.ExecuteNonQuery();
        con.Close();
        Response.Redirect("expertdoubtsrespons.aspx");
    }
}