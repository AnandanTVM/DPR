<%@ Page Title="" Language="C#" MasterPageFile="~/supportteam.master" AutoEventWireup="true" CodeFile="supportrec.aspx.cs" Inherits="supportrec" %>
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
    ...
    <Columns>
        ...
        <asp:HyperLinkField DataNavigateUrlFields="cid" 
            DataNavigateUrlFormatString="supportrec1.aspx?{0}" DataTextField="title" 
            HeaderText="SUBJECT" />
    </Columns>
