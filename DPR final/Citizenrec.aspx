<%@ Page Title="" Language="C#" MasterPageFile="~/citizen.master" AutoEventWireup="true" CodeFile="Citizenrec.aspx.cs" Inherits="Citizenrec" %>
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
    ...
    <Columns>
        ...
        <asp:HyperLinkField DataNavigateUrlFields="cid" 
            DataNavigateUrlFormatString="Citizenrec1.aspx?{0}" DataTextField="title" 
            HeaderText="SUBJECT" />
    </Columns>
