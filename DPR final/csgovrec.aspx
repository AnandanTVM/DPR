<%@ Page Title="" Language="C#" MasterPageFile="~/csgov.master" AutoEventWireup="true" CodeFile="csgovrec.aspx.cs" Inherits="csgovrec" %>
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
    ...
    <Columns>
        ...
        <asp:HyperLinkField DataNavigateUrlFields="cid" 
            DataNavigateUrlFormatString="csgovrec1.aspx?{0}" DataTextField="title" 
            HeaderText="SUBJECT" />
    </Columns>
